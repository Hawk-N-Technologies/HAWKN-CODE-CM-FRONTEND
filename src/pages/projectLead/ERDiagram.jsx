...
function ERDiagram() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-xl font-bold text-cm-text">ERP / ER Diagram</h1>
        <p className="mt-1 text-sm text-cm-text-muted">
          Upload and maintain the project's ER diagram.
        </p>
      </div>
      ...
      <section className="rounded-cm-lg border border-cm-border bg-cm-card p-6 shadow-sm">
        <FileUpload
          ...
          helperText={file?.name ?? "Upload the project ER diagram."}
        />
        {file && (
        ...
        <div className="mt-6 flex justify-end border-t border-cm-border pt-4">
          <Button
            disabled={!file}
            onClick={() => showToast.success("ER diagram saved.")}
          >
            Save Diagram
          </Button>
        </div>
