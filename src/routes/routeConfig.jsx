 ...
 * route block (see AppRoutes.jsx). Only lists pages that actually exist
 * under src/pages/<role>/ — add entries here as each page gets built,
 * not ahead of it.
 */
const ICONS = {
  overview: (
  ...
  policies: (
    ...
    >
      <path
        d="M14 3v5a2 2 0 0 0 2 2h5M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2ZM9 13h6M9 17h6"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
  ...
  people: (
    ...
    >
      ...
      <path
        d="M2 21c0-3.5 3-6 7-6s7 2.5 7 6M16 11a3 3 0 1 0 0-6M17 21c0-2.2-.9-4-2.3-5.2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
/**
 * Nav sections keyed by role. Add more roles here as their module
 * pages get built out.
 */
